...
typedef struct _AITS_SD {
	...
	#define TYPE_1_0							0x00
	#define TYPE_2_0							0x80
	#define CMD_MODE_DRIVEN_BY_PULL_UP 		0x00	
	#define CMD_MODE_DRIVEN_BY_CHIP			0x40
        /*-DEFINE-----------------------------------------------------*/
//        #define RISING_EDGE             0x80
    ...
    #if (CHIP == VSN_V3)
    AIT_REG_B   							_0x0F;
    AIT_REG_B   SD_DATA_TOUT[3];                               // 0x10
    AIT_REG_B   SD_RX_EDGE;                               // 0x13    
    	#define RISING_EDGE 		0x01
    	#define FALLING_EDGE		0x00		
    #elif (CHIP == MCR_V2) || (CHIP == MERCURY)
	...
	#else
	#error Please, define what CHIP you use
	#endif
    ...
    AIT_REG_B   SD_CPU_FIFO_SR;                             // 0x22
        ...
        #define SD_FIFO_FULL               0x08
        #define SD_FIFO_EMPTY              0x04
        #define FIFO_GE                 0x02
        #define FIFO_LE                 0x01
        /*------------------------------------------------------------*/
    ...
    AIT_REG_B   SD_CPU_INT_EN_3;                            // 0x27
        ...
        /*------------------------------------------------------------*/
    AIT_REG_W   SD_HOST_INT_SR;                             // 0x28~0x29
    AIT_REG_B   SD_HOST_INT_SR_2;                           // 0x2A
    AIT_REG_B   SD_HOST_INT_SR_3;                           // 0x2B
    AIT_REG_W   SD_HOST_INT_EN;                             // 0x2C~0x2D
    ...
    AIT_REG_B   _0x49;                               // 0x49    
    AIT_REG_W   SD_RX_CLK_DELAY;                         // 0x4a~0x4b
    AIT_REG_B   _0x4c[0xB3];                                // 0x49 - 0xFF
} AITS_SD, *AITPS_SD;

#define AITSD_REGS_SIZE 0x48

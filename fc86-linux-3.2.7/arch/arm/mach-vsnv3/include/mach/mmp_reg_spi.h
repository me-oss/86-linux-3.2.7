...
typedef struct _AITS_SPI {
    ...
    AIT_REG_W   SPI_CFG;		//0x04
		...
		#define SCLK_PHA_HIGH 			 	 0x0002
		#define SCLK_POL_LOW 			 	 0x0000
		#define SCLK_POL_HIGH			 	 0x0001
        /*------------------------------------------------------------*/
    AIT_REG_B   SPI_WORD_LEN;	//0x06
    		#define SPI_BITCOUNT_MASK			0x3f
    AIT_REG_B                           _x07;
...
#define SPI_GET_XCH_CTL(port) ait_spi_readb(port,SPI_XCH_CTL)

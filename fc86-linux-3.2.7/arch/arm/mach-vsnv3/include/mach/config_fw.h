...
/** @} */ // end of System
    ...
    #if BOOT_4K_ITCM==1
    #define USB_POWER_EN            (0) // power on usb in firmware, not in bootcode
    #define AIT_BOOTCODE_FLASH_ADDR     (0x00000000)
    #define AIT_BOOTCODE_FLASH_SIZE     (0x8000) // total boot code size
    #define AIT_BC1_FLASH_SIZE          (0x1000) // boot code 1 in ITCM
    #define AIT_FW_FLASH_ADDR           (0x8000) //32K start
    #else
    ...
    #if CPU_216_G0_216
        #define G0_CLK      (216000)
        #define CPU_MHZ     (CPU_216)
    #endif
    #if CPU_300_G0_192
        #define G0_CLK      (120000)
	...
	#define ENABLE_SKIP_FRAME_FOR_CROP (1)
    ...
    #define FW_RELEASE_TARGET   JTAGDBG_REL//NORMAL_REL   //JTAGDBG_REL
    ...
    */
    ...
    #define FULLHD_VIDEO_ENCODE_MAX_FRAME_RATE    (30)
    ...
    #define RAW_PREVIEW_USING_YUY2_PAYLOAD    (1)
    #define RAW_PREVIEW_USING_MJPEG_PAYLOAD   (0)
...
@{ */
    ...
    #define MMU_TRANSLATION_TABLE_ADDR         (0x12C000)
    ...
    #endif
    #if (CHIP == VSN_V3)
    #define SRAM_START_ADDR                     (0x104000)
    #define H264E_EXCLUSIVE_SRAM_ADDR           (0x126000)
    #endif
...
#elif (BIND_SENSOR_AR0330) || (BIND_SENSOR_OV2724) || (BIND_SENSOR_OV5690) || (BIND_SENSOR_OV5650) || (BIND_SENSOR_S5K4E5)\
    || (BIND_SENSOR_IMX175)
...
/** @} */ // end of H264
    ...
    //
    #define USING_UVCX_VIDEO_CONFIG (0)
/** @name APP
@{ */
    #if (CHIP == P_V2)||(CHIP == VSN_V2)||(CHIP == VSN_V3)
	#define ARCSOFT_APP_EN      (0) // 0: Disable Arcsoft applications, 1: Enable Arcsoft applications
        ...
        #define ARCSOFT_SDTC_EN (0) // 0: Disable Arcsoft smail detection, 1: Enable Arcsoft smile detection
	#endif
    /** @} */ // end of APP

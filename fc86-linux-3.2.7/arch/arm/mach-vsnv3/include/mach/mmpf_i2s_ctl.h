...
extern void	MMPF_SetI2SMode(MMP_USHORT i2s_mode, MMP_USHORT lrck_mode, MMP_USHORT output_bits);
extern void	MMPF_SetI2SFreq(MMP_ULONG freq);
void	MMPF_PresetI2S(MMP_USHORT direction,MMP_USHORT mode,MMP_USHORT alignment);
extern void	MMPF_CloseI2S(void);

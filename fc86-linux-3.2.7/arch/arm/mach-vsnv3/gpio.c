...
static struct at91_gpio_chip gpio_chip[] = {
	AT91_GPIO_CHIP("GPIO", 0x00 , 66),
#if 0		
	AT91_GPIO_CHIP("B", 0x20 + PIN_BASE, 32),
	AT91_GPIO_CHIP("C", 0x40 + PIN_BASE, 17),
	AT91_GPIO_CHIP("D", 0x60 + PIN_BASE, 5),
...
int __init_or_module vsnv3_set_gpio_output(unsigned pin, int value)
{
	...
	MMPF_PIO_EnableOutputMode((MMPF_PIO_REG) pin, (MMP_BOOL)value);
#if 0
	void __iomem	*pio = pin_to_controller(pin);
	unsigned	mask = pin_to_mask(pin);
...
x
void vsnv3_gpio_sxsuspend(void)
{
	int i;
#if 0
...
static const struct file_operations at91_gpio_operations = {
	.open		= NULL,//at91_gpio_open,
	.read		= NULL,//seq_read,
	.llseek		= NULL,//seq_lseek,
	.release	= NULL,//single_release,
};
 ...
 */
void __init at91_gpio_init(struct vsnv3_gpio_bank *data, int nr_banks)
{
	MMPF_PIO_Initialize();
